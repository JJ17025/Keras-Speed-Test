...
printt('')
printt('speed test --> i9 13900 precision 3660, RAM 64 GB, SSD pcie')
printt('0:00:04.064782 --> create image 1000img/class x 2class = 2000img')
printt('0:00:42.520251 --> training 2000img 5epoch')
printt('0:00:00.076903 --> predict 1')
printt('0:00:00.010002 --> predict 2')
printt('')
printt('speed test --> i5 13600K, RAM 32 GB, SSD pcie')
printt('0:00:03.824338 --> create image 1000img/class x 2class = 2000img')
printt('0:00:34.506524 --> training 2000img 5epoch')
printt('0:00:00.060309 --> predict 1')
printt('0:00:00.006977 --> predict 2')
printt('')
